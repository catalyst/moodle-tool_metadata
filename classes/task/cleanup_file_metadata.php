...
/**
 * The schedules task for cleaning up metadata for removed files.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class cleanup_file_metadata extends scheduled_task {
    ...
    /**
     * Delete all extractions for which the corresponding file has been removed.
     */
    public function delete_extractions_for_removed_files() : bool {
        global $DB;

        // We use a left outer join here to capture all {metadata_extractions} which have a contenthash
        // that is no longer present in {files}.
        $sql = "DELETE e
                FROM {metadata_extractions} e
                LEFT OUTER JOIN {files} f
                    ON e.contenthash = f.contenthash
